...
public interface INhlLeagueApi
{
    ...
    /// </summary>
    /// <param name="cancellationToken"> A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns> The collection of all NHL teams including active and inactive teams</returns>
    public Task<TeamsResponse> GetAllTeamsAsync(CancellationToken cancellationToken = default);
    ...
    public Task<TeamDetail> GetTeamDetailBySeasonYearAndGameTypeAsync(int teamId, string seasonYear, GameType gameType, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>Returns the NHL Edge team detail payload for the requested team, season, and game type</returns>
    public Task<TeamDetail> GetTeamDetailBySeasonYearAndGameTypeAsync(TeamEnum team, string seasonYear, GameType gameType, CancellationToken cancellationToken = default);
    ...
    public Task<TeamComparison> GetTeamComparisonBySeasonYearAndGameTypeAsync(int teamId, string seasonYear, GameType gameType, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>Returns the NHL Edge team comparison payload for the requested team, season, and game type</returns>
    public Task<TeamComparison> GetTeamComparisonBySeasonYearAndGameTypeAsync(TeamEnum team, string seasonYear, GameType gameType, CancellationToken cancellationToken = default);
    ...
    public Task<List<TeamSkatingDistanceTop10>> GetTeamSkatingDistanceTop10BySeasonYearAndGameTypeAsync(string positions, string strength, string sortBy, string seasonYear, GameType gameType, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>Returns the NHL Edge team skating distance top 10 payload for the requested filters</returns>
    public Task<List<TeamSkatingDistanceTop10>> GetTeamSkatingDistanceTop10ByNowAsync(string positions, string strength, string sortBy, CancellationToken cancellationToken = default);
    ...
    public Task<TeamSkatingDistanceDetail> GetTeamSkatingDistanceDetailBySeasonYearAndGameTypeAsync(int teamId, string seasonYear, GameType gameType, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>Returns the NHL Edge team skating distance detail payload for the requested team, season, and game type</returns>
    public Task<TeamSkatingDistanceDetail> GetTeamSkatingDistanceDetailBySeasonYearAndGameTypeAsync(TeamEnum team, string seasonYear, GameType gameType, CancellationToken cancellationToken = default);
}
