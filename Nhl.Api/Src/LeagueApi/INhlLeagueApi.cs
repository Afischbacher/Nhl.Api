...
public interface INhlLeagueApi
{
    ...
    public Task<TeamLogo> GetTeamLogoAsync(int teamId, TeamLogoType teamLogoType = TeamLogoType.Light);
    ...
    /// <returns>Returns NHL team logo information including a byte array, base64 encoded string and the uri endpoint</returns>
    public Task<TeamLogo> GetTeamLogoAsync(TeamEnum team, TeamLogoType teamLogoType = TeamLogoType.Light);
    ...
    public Task<TeamColors> GetTeamColorsAsync(TeamEnum team);
    ...
    /// <param name="teamId">The NHL team identifier - Seattle Kraken: 55</param>
    /// <returns>An NHL team color scheme using hexadecimal codes</returns>
    public Task<TeamColors> GetTeamColorsAsync(int teamId);
    ...
    public Task<LeagueSchedule> GetLeagueGameWeekScheduleByDateAsync(DateOnly date);
    ...
    public Task<TeamWeekSchedule> GetTeamWeekScheduleByDateAsync(string teamAbbreviation, DateOnly date);
    ...
    /// <returns>A collection of all games in the requested season for the requested NHL team</returns>
    public Task<TeamSchedule> GetTeamScheduleBySeasonAsync(string teamAbbreviation, string seasonYear);
    ...
    public Task<bool> IsPreSeasonActiveAsync();
    /// <summary>
    ...
    public Task<bool> IsRegularSeasonActiveAsync();
    ...
    public Task<bool> IsPlayoffSeasonActiveAsync();
    ...
    public Task<LeagueStanding> GetLeagueStandingsByDateAsync(DateOnly date);
    ...
    public Task<LeagueStandingsSeasonInformation> GetLeagueStandingsSeasonInformationAsync();
    ...
    public Task<TeamSeasonRoster> GetTeamRosterBySeasonYearAsync(int teamId, string seasonYear);
    ...
    /// <param name="seasonYear">The eight digit number format for the season, see <see cref="SeasonYear"/> for more information, Example: 20232024</param>
    /// <returns>Returns the NHL team roster for a specific team by the team identifier and season year</returns>
    public Task<TeamSeasonRoster> GetTeamRosterBySeasonYearAsync(TeamEnum team, string seasonYear);
    ...
    public Task<List<int>> GetAllRosterSeasonsByTeamAsync(int teamId);
    ...
    /// <param name="team">The NHL team identifider, see <see cref="TeamEnum"/> for more information, Example: 9 - Ottawa Senators </param>
    /// <returns>Returns every active season for an NHL team and their participation in the NHL</returns>
    public Task<List<int>> GetAllRosterSeasonsByTeamAsync(TeamEnum team);
    ...
    /// <param name="teamId">The NHL team identifider, Example: 55 - Seattle Kraken</param>
    /// <returns></returns>
    public Task<TeamProspects> GetTeamProspectsByTeamAsync(int teamId);
    ...
    /// <returns></returns>
    public Task<TeamProspects> GetTeamProspectsByTeamAsync(TeamEnum team);
    ...
    public Task<LeagueSchedule> GetLeagueWeekScheduleByDateAsync(DateOnly date);
    ...
    public Task<LeagueScheduleCalendar> GetLeagueScheduleCalendarByDateAsync(DateOnly date);
    ...
    public Task<List<GameWatchSource>> GetSourcesToWatchGamesAsync();
    ...
    public Task<TvScheduleBroadcast> GetTvScheduleBroadcastByDateAsync(DateOnly date);

    /// <summary>
    /// Returns all the NHL seasons for the NHL league
    /// </summary>
    /// <returns>Returns all the NHL seasons for the NHL league</returns>
    public Task<List<int>> GetAllSeasonsAsync();
    ...
    public Task<LeagueMetadataInformation> GetLeagueMetadataInformationAsync(List<int> playerIds, List<string> teamIds);
    ...
    /// <returns>Returns the metadata information about the NHL league including players, teams and season states</returns>
    public Task<LeagueMetadataInformation> GetLeagueMetadataInformationAsync(List<PlayerEnum> players, List<TeamEnum> teams);
    ...
    public Task<bool> IsLeagueActiveAsync();
