...
namespace Nhl.Api
{
    ...
    public interface INhlStatisticsApi
    {
        ...
        /// <returns>Returns the player profile with the top player statistic in the specified NHL season</returns>
        Task<List<PlayerStatisticResult>> GetPlayersWithTopStatisticBySeasonAsync(PlayerStatisticEnum playerStatisticEnum, string seasonYear, int numberOfPlayers = 10);
        ...
        /// <returns>Returns the goalie profile with the top player statistic in the specified NHL season</returns>
        Task<List<GoalieStatisticResult>> GetGoaliesWithTopStatisticBySeasonAsync(GoalieStatisticEnum goalieStatisticEnum, string seasonYear, int numberOfGoalies = 10);
    }
}
