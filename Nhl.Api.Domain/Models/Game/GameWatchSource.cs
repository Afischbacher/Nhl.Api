...
public class GameWatchSource
{
    ...
    public required string StreamingName { get; set; }
    ...
    public required string StreamingSiteUrl { get; set; }
    ...
    public required string StreamingLogoUrl { get; set; }
    ...
    public required string PrimaryBroadcastName { get; set; }
    ...
    public required string PrimaryBroadcastSiteUrl { get; set; }
    ...
    public required string PrimaryBroadcastLogoUrl { get; set; }
    ...
    public required string SecondaryBroadcastName { get; set; }
    ...
    public required string SecondaryBroadcastSiteUrl { get; set; }
    ...
    public required string SecondaryBroadcastLogoUrl { get; set; }
}
