...
public class TeamSeasonSchedule
{
    ...
    /// </summary>
    [JsonProperty("games")]
    public required List<TeamSeasonScheduleGame> Games { get; set; } = [];
}
...
public class TeamSeasonScheduleAwayTeam
{
    ...
    public required string AirlineDesc { get; set; }
    ...
    public required string HotelLink { get; set; }
    ...
    public required string HotelDesc { get; set; }
